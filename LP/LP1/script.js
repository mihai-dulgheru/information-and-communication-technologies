    ...
    switch (clicked) {
      ...
      case '=':
        ...
        if (display.innerHTML.includes('+')) {
          if (
            Number(display.innerHTML.substring(0, display.innerHTML.indexOf('+'))) === 0 &&
            Number(display.innerHTML.substring(display.innerHTML.indexOf('+') + 1)) === 0
          ) {
            display.innerHTML = '0';
            break;
          }
        ...
        if (display.innerHTML.includes('x')) {
          if (
            Number(display.innerHTML.substring(0, display.innerHTML.indexOf('x'))) === 0 ||
            Number(display.innerHTML.substring(display.innerHTML.indexOf('x') + 1)) === 0
          ) {
            display.innerHTML = '0';
            break;
          }
        ...
        if (display.innerHTML.includes('/')) {
          if (Number(display.innerHTML.substring(display.innerHTML.indexOf('/') + 1)) === 0) {
            display.innerHTML = '';
            alert('Cannot divide by zero');
            break;
          }
          if (Number(display.innerHTML.substring(0, display.innerHTML.indexOf('/'))) === 0) {
            display.innerHTML = '0';
            break;
          }
        }
      ...
      case '.':
        if (
          ...
          (display.innerHTML.match(/[-+x/]/) &&
            !display.innerHTML.slice(display.innerHTML.match(/[-+x/]/).index + 1))
        ) {
          display.innerHTML += '0.';
        } else {
